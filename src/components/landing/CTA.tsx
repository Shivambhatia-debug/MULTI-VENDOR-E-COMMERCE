            ...
            <div className="bg-slate-950 rounded-[3rem] p-8 md:p-24 overflow-hidden relative group shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] border border-white/5">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-12">
                        <Sparkles size={12} />
                        <span>The Noir Design Protocol</span>
                    </div>
                    ...
                    <h2 className="text-4xl md:text-7xl font-black text-white mb-10 max-w-4xl leading-[0.9] tracking-tighter uppercase">
                        ...
                        <span className="text-slate-400 font-medium">in record time.</span>
                    </h2>

                    <p className="text-slate-400 text-sm md:text-base mb-12 max-w-xl leading-relaxed font-medium">
                        Join 12,000+ merchants who trust the Golalita ecosystem to power their
                        global storefronts, logistics, and customer experiences.
                    </p>
                    ...
                    <div className="mt-20 pt-10 border-t border-white/5 w-full">
                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-10">Trusted by fast-growing brands</p>
