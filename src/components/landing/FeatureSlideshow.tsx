...
const slides = [
    {
        title: "Store Builder",
        desc: "Design your own professional online store with ease. Choose from unique layouts to match your brand, no coding required.",
        image: "/noir_store_builder_mockup.png",
        accent: "bg-slate-950"
    },
    {
        title: "Sell Everywhere",
        desc: "Launch your products on our global marketplace. Enjoy 0% commission on all your sales and reach customers worldwide.",
        image: "/marketplace_hero.png",
        accent: "bg-slate-950"
    },
    {
        title: "Manage Your Store",
        desc: "The heartbeat of your business. Track your stock, manage multiple branches, and see your sales history in one simple dashboard.",
        image: "/merchant_console_hero.png",
        accent: "bg-slate-950"
    },
    {
        title: "Choose Your Plan",
        desc: "Simple subscription packages for every business. Get the perfect set of features with our Basic, Premium, or Mobile App plans.",
        image: "/logistics_hero.png",
        accent: "bg-slate-950"
    },
    {
        title: "Merchant App",
        desc: "Run your business from anywhere. Our mobile app lets you manage orders and tracking directly from your smartphone.",
...
export default function FeatureSlideshow() {
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden bg-black flex items-center pt-20">
            ...
            <div className="section-padding relative z-10 w-full mb-32">
                <div className="max-w-4xl">
                    ...
                    >
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-6 block">Feature Spotlight</span>
                        ...
                        <div className="flex items-center gap-8">
                            <button className="bg-white text-black px-12 py-5 rounded-full text-[11px] font-black uppercase tracking-widest flex items-center gap-3 hover:bg-slate-100 transition-all shadow-2xl">
                                Explore Detail <ArrowRight size={18} />
                            </button>
